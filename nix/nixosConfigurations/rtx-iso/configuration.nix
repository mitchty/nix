...
let
  ...
  # builtin ssd is disk0 according to pci layout
  disk0 = "/dev/disk/by-id/nvme-Samsung_SSD_990_PRO_4TB_S7KGNJ0X201453Y";
  disk1 = "/dev/disk/by-id/nvme-Samsung_SSD_990_PRO_4TB_S7KGNJ0X207489F";
