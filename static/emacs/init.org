...
(use-package tree-sitter-indent
  ...
  :ensure
  :hook
  ((sh-mode nix-mode go-mode rust-mode c-mode) . tree-sitter-indent-mode))
...
(use-package eglot
  :ensure
  :hook ((sh-mode go-mode rust-mode nix-mode python-mode c-mode yaml-mode dockerfile-mode markdown-mode json-mode) . eglot-ensure))
