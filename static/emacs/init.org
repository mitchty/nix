...
(use-package fancy-dabbrev
  ...
  ;; Don't seem to work in :hook macro
  (add-hook 'prog-mode-hook (local-set-key (kbd "<tab>") 'fancy-dabbrev-expand-or-indent))
  (add-hook 'text-mode-hook (local-set-key (kbd "<tab>") 'fancy-dabbrev-expand-or-indent))
