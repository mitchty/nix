...
Trying out eca for abominable intelligence integration.

#+BEGIN_SRC emacs-lisp :tangle yes
(use-package eca :ensure :defer)
#+END_SRC
...
TODO: this shits not working with ollama for some reason, future mitch figure it out
#+BEGIN_SRC emacs-lisp :tangle no
